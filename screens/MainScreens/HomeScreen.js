    ...
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.subtext}>
          GRASP makes Helping General public Reach Astonishing Science Profiency. Choose an option to get started!
        </Text>
      </View>
